...
\begin{itemize}[nosep]
    \item \textbf{Sample size}: Primary results use n=30; validated at n=1,252 for top configurations. Full-scale validation of frontier configurations would strengthen claims.
